...
export OUTPUT_DIR="$COREF_DIR/bert2bert_output"
export CACHE_DIR="$COREF_DIR/bert2bert_cache"
export MODEL_DIR="$COREF_DIR/bert2bert_model"
export DATA_DIR="$COREF_DIR/bert2bert_coref_data"
export SPLIT_FOR_EVAL=test

python run_bert2bert_coref.py \
