...
def handle_line(line, document_state, language, labels, stats):
    ...
    if begin_document_match:
        ...
        if len(row) == 0:
            ...
            document_state.full_sentences.append(tuple(document_state.full_text))
            del document_state.text[:]
            del document_state.full_text[:]
        ...
        document_state.full_text.append(line)
...
if __name__ == "__main__":
    ...
    minimize_partition(input_path, 'english', "", labels, stats)
